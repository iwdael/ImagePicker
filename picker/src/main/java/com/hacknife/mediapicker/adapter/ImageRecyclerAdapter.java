...
import com.hacknife.mediapicker.ui.ImageBaseActivity;
            ...
            mItemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!((ImageBaseActivity) mActivity).checkPermission(Manifest.permission.CAMERA)) {
                        ActivityCompat.requestPermissions(mActivity, new String[]{Manifest.permission.CAMERA}, MediaGridActivity.REQUEST_PERMISSION_CAMERA);
                    } else {
                        imagePicker.takePicture(mActivity, MediaPicker.REQUEST_CODE_TAKE);
                    }
                }
            });
        }
