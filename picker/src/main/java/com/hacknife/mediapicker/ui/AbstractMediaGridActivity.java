...
import com.hacknife.mediapicker.MediaDataSource;
import com.hacknife.mediapicker.MediaPicker;
import com.hacknife.mediapicker.MediaType;
import com.hacknife.mediapicker.R;
import com.hacknife.mediapicker.adapter.ImageFolderAdapter;
import com.hacknife.mediapicker.adapter.ImageRecyclerAdapter;
...
import com.hacknife.mediapicker.view.FolderPopUpWindow;
import com.hacknife.mediapicker.view.GridSpacingItemDecoration;
 ...
 * project : MediaPicker
 */
public abstract class AbstractMediaGridActivity extends ImageBaseActivity implements MediaDataSource.OnImagesLoadedListener, ImageRecyclerAdapter.OnImageItemClickListener, MediaPicker.OnPictureSelectedListener, View.OnClickListener {

    public static final String TAG = AbstractMediaGridActivity.class.getName();
    ...
    private void initRecycler() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            if (checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new MediaDataSource(this, null, imagePicker.getLoadType(), this);
            } else {
        ...
        if (data != null && data.getExtras() != null) {
            ...
            if (directPhoto) {
                if (!(checkPermission(Manifest.permission.CAMERA))) {
                    ...
                    imagePicker.takePicture(this, MediaPicker.REQUEST_CODE_TAKE);
                }
            }
    ...
    public void onClick(View v) {
        ...
        if (id == attachButtonOkRes()) {
            ...
            intent.putExtra(MediaPicker.EXTRA_SELECTED_IMAGE_POSITION, 0);
            intent.putParcelableArrayListExtra(MediaPicker.EXTRA_IMAGE_ITEMS, imagePicker.getSelectedImages());
            intent.putExtra(AbstractImagePreviewActivity.ISORIGIN, isOrigin);
            intent.putExtra(MediaPicker.EXTRA_FROM_ITEMS, true);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && data.getExtras() != null) {
            if (resultCode == MediaPicker.RESULT_CODE_BACK) {
                ...
                //从拍照界面返回
                //点击 X , 没有选择照片
                if (data.getParcelableArrayListExtra(MediaPicker.EXTRA_RESULT_ITEMS) == null) {
                    //什么都不做 直接调起相机
                } else {
            ...
            if (resultCode == RESULT_OK && requestCode == MediaPicker.REQUEST_CODE_TAKE) {
                //发送广播通知图片增加了
                MediaPicker.galleryAddPic(this, imagePicker.getTakeImageFile());
