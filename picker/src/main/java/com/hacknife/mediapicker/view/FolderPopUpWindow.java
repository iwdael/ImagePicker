package com.hacknife.mediapicker.view;
...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        ...
        final View view = View.inflate(context, com.hacknife.mediapicker.R.layout.imagepicker_pop_folder, null);
        masker = view.findViewById(com.hacknife.mediapicker.R.id.masker);
        masker.setOnClickListener(this);
        marginView = view.findViewById(com.hacknife.mediapicker.R.id.margin);
        marginView.setOnClickListener(this);
        listView = (ListView) view.findViewById(com.hacknife.mediapicker.R.id.listView);
